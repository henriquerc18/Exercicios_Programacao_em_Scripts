		...
		<?php
			class Triangulo {
				...
				function verificarClassificacao(){
					...
					}else if ($this->primeiroLado == $this->segundoLado && $this->primeiroLado == $this->terceiroLado){
						echo "Triângulo Equilátero";
					}else if ($this->primeiroLado != $this->segundoLado && $this->primeiroLado != $this->terceiroLado && $this->segundoLado != $this->terceiroLado){
