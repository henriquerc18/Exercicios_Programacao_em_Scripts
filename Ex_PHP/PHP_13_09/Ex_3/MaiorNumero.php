...
<html>
	...
	<body>
		<?php
			...
			echo "O maior número é: ". $maiorNumero->getNumeroMaior(). "<br>";
			echo $maiorNumero->getNumeroMenor()."<br>";
			echo $maiorNumero->getNumeroMedio()."<br>";
			echo $maiorNumero->getNumeroMaior()."<br>";
